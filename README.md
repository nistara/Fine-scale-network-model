...
This repository contains scripts for the publication "Fine scale infectious disease spatial modeling using satellite-derived data: application to pandemic influenza in Rwanda".
